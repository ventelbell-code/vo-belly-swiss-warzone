      ...
      <DialogContent className="sm:max-w-sm bg-card border-border p-0 gap-0">
        ...
        <Tabs defaultValue="usdt" className="w-full">
          <TabsList className="w-full rounded-none border-b border-border bg-transparent h-auto p-0">
            <TabsTrigger
              value="usdt"
              className="flex-1 rounded-none border-b-2 border-transparent data-[state=active]:border-amber-500 data-[state=active]:bg-transparent data-[state=active]:text-foreground py-2.5 text-xs font-medium"
            >
              USDT TRC20
            </TabsTrigger>
            <TabsTrigger
          ...
          {/* USDT Tab */}
          <TabsContent value="usdt" className="mt-0 p-5 space-y-4">
            {/* QR Code - 25% smaller, centered, no shadows */}
            <div className="flex justify-center">
              <div className="relative w-36 h-36 bg-white rounded">
                <Image
            ...
            <div className="flex items-center gap-2 bg-muted/30 rounded px-3 py-2">
              <code className="flex-1 text-[10px] text-foreground/80 break-all font-mono">
                {USDT_ADDRESS}
              </code>
              <button
          ...
          {/* PayPal Tab */}
          <TabsContent value="paypal" className="mt-0 p-5">
            <div className="flex items-center gap-3">
              ...
              {/* Email with copy */}
              <div className="flex-1 flex items-center gap-2 bg-muted/30 rounded px-3 py-2">
                <span className="flex-1 text-xs text-foreground/80 font-mono">
                  {PAYPAL_EMAIL}
                </span>
                <button
