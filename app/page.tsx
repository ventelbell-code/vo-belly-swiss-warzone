...
const weeklyData = [
  ...
  { day: "Miércoles", shortDay: "Mie", profit: -45.20, percentage: -0.09, operations: 1, cumulative: 50390.10,
  ...
  { day: "Sábado", shortDay: "Sab", profit: 0, percentage: 0, operations: 0, cumulative: 50859.40,
    intraday: [50859.40] },
...
const navItems = [
  ...
  { label: "Configuración", href: "/dashboard/settings", icon: Settings, active: false },
